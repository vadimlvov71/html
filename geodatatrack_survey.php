                   ...
                   <div class='row'>";
                       ...
                       ";
                                foreach($value5 as $key => $value){
                                    echo "<tr>
                                        <td class='clickable' style='padding-left:11px;'>".$key."</td>
                                ...
                                <div class='row row-block1 form-block'>
                                    ...
                                    <div class='col-sm-8 '>
                                        ...
                                        <div style='padding:1px 0 0px 0;'>
                                           ...
                                           <div style='text-align:right'><img src='images/field.jpeg' width='300' align='right123'></div>
                                       </div>
                                       <div class='devide'></div>
                                       <div class='label'>Notes:  ?????</div>
                                       <div class='description notes'>Lorem Ipsum is simply dummy text of the printing and typesetting industry</div>
                                       <div class='description notes'>Ipsum is simply dummy text of the printing and typesetting industry</div>
                                       <div class='description notes'>Simply dummy text of the printing and typesetting industry</div>
                                    </div>
                                </div>
                                <!-- -->
